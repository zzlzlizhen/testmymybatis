...
import lz.model.RoleResourceExample.Criteria;
import lz.model.RoleResourceExample.Criterion;
...
public class RoleResourceSqlProvider {
    ...
    public String insertSelective(RoleResource record) {
        ...
        if (record.getResourceId() != null) {
            VALUES("resource_id", "#{resourceId,jdbcType=CHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getResourceId() != null) {
            SET("resource_id = #{record.resourceId,jdbcType=CHAR}");
        }
    ...
    protected void applyWhere(RoleResourceExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
