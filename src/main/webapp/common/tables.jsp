...
<!-- Bootstrap -->
<link rel="stylesheet"
	href="${ctx}/asset/lib/bootstrap-2.3.2/css/bootstrap.min.css"
	media="screen">
<link rel="stylesheet"
	href="${ctx}/asset/lib/bootstrap-2.3.2/css/bootstrap-responsive.min.css"
	media="screen">
<!-- FontAwesome -->
<link rel="stylesheet"
	href="${ctx}/asset/lib/font-awesome-4.2.0/css/font-awesome.min.css">
...
<!-- lhgdialog -->
<script
	src="${ctx}/asset/lib/lhgdialog-4.2.0/lhgdialog.js?skin=bootstrap2"></script>
<!-- DataTables JS-->
<script
	src="${ctx}/asset/lib/dataTables-1.10.7/media/js/jquery.dataTables.js"></script>
<script
	src="${ctx}/asset/lib/dataTables-1.10.7/plugins/integration/bootstrap/2/dataTables.bootstrap.js"></script>
<!-- DataTables JS end-->
