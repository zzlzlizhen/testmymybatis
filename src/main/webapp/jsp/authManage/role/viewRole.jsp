...
<body>
	...
	<form class="form-horizontal" role="form">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label"> 角色名字： </label>
			<div class="col-sm-9">
				<input type="text" class="form-control" value="${role.roleType}"
					disabled="disabled">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" value="${role.createTime}"
					disabled="disabled">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" value="${role.updateTime}"
					disabled="disabled">
			</div>
		</div>
		<div class="form-group">
