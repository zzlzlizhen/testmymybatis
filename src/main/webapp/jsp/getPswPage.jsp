		...
		<div class="row">
			...
			<div class="row">
				<div class="well col-md-8 center login-box">
					...
					<input type="hidden" id="resetPswUserName" /> <input type="hidden"
						id="resetPswPhone" /> <input type="hidden" id="resetPswSecurity" />
					...
					<div class="row">
						<div class="col-md-6"
							style="text-align: left; padding-left: 200px;">
							<button type="button" class="btn btn-default" id="prex"
								onclick="prexOper()">上一步</button>
						</div>
						<div class="col-md-6"
							style="text-align: right; padding-right: 200px;">
							<button type="button" class="btn btn-primary" id="next"
								onclick="nextOper()">下一步</button>
						</div>
					</div>
				</div>
				<!--/span-->
