...
<script type="text/javascript">
		...
		table = $('#dataTables').dataTable(
						{
							...
							"sAjaxSource" : "${appctx}/clothesManagerController/getParams",
	...
	function viewFun(id){
		...
		$("#saveBtn").hide();
		$("#myModal").modal({
		    remote: "${appctx}/clothesManagerController/viewPage/"+id
		});
	}
	function addFun(){
		...
		$("#saveBtn").show();
		$("#myModal").modal({
		    remote: "${appctx}/clothesManagerController/addPage"
		});
	}
	function editFun(id){
		...
		$("#saveBtn").show();
		$("#myModal").modal({
		    remote: "${appctx}/clothesManagerController/editPage/"+id
		});
	}
	function delFun(id){
		delId = id;
	...
	function delSubmit(){
		$.ajax({
	        url: '${appctx}/clothesManagerController/del',
	        async: true,
	...
	function batchDelSubmit(){
		$.ajax({
	        url: '${appctx}/clothesManagerController/batchDel',
	        async: true,
	        contentType:"application/json",
	        type: 'POST',
