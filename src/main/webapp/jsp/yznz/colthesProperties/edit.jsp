...
<script type="text/javascript">
	$(function() {
		var originParamKey = $("#paramKey").val();
		$("#paramKey").val(transProperties(originParamKey));
	});
	function saveSubmit(){
		if($("#paramKey").val()==null||(!$("#paramKey").val().length>0)){
			...
			$.ajax({
		        url: '${appctx}/yznz/colthesProperties/edit',
		        async: true,
		        contentType:"application/json",
		        type: 'POST',
		        data: JSON.stringify({id:$("#id").val(),paramKey:'${systemParam.paramKey}',paramValue:$("#paramValue").val()}),
...
<body>
	...
	<form class="form-horizontal" role="form">
	   <div class="form-group">
	      ...
	      <div class="col-sm-9">
	         <input type="text" id="paramKey" class="form-control" value="${systemParam.paramKey}" disabled="disabled">
	      </div>
	   </div>
	   <div class="form-group">
	      <label class="col-sm-3 control-label">
